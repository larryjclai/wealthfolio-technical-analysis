...
export const SymbolPicker: React.FC<Props> = ({ onSelect, defaultSymbol = '2330', defaultMarket = 'TWSE' }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-3 items-center p-4 border border-zinc-800 rounded-xl bg-zinc-900 shadow-sm">
      ...
      <input 
        ...
        className="bg-zinc-800 border border-zinc-700 text-zinc-100 rounded-lg px-4 py-2 flex-grow focus:outline-none focus:ring-2 focus:ring-blue-500/50 placeholder:text-zinc-500 transition-colors"
      />
